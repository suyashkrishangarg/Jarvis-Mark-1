from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QLabel, QTextEdit, QFrame, QPushButton, QHBoxLayout, QStackedWidget, QSizePolicy, QMainWindow
...
def QueryModifier(Query):
    ...
    # Check if the query starts with any typical question word.
...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        # Removed duplicate addition of self.gif_label
        font = QFont()
    ...
    def addMessage(self, message, color):
        ...
        char_format = QTextCharFormat()  # renamed to avoid shadowing built-in 'format'
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        self.maximize_icon = maximize_icon  # Save maximize_icon for later use
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()  # Removed duplicate super().__init__()
